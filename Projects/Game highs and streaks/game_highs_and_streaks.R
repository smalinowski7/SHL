...
ggsave("test.jpg", height = 15, width = 7, dpi = 300)
...
ggplot(streak_plot, aes(x = streak_length, y = fct_rev(plot_id), fill = streak_length)) +
  ...
  scale_fill_gradient(low = "grey85", high = "#5C0029") +
  labs(x = "Streak length", y = NULL, title = "SHL hit streaks")

ggsave("Projects/Game highs and streaks/plots/hit_streak.jpg", 
       width = 6.5,
       height = 7.5,
       dpi = 300)

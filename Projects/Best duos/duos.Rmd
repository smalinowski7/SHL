...
ggsave("Plots/best_duos.jpg", width = 8, height = 10, dpi = 300)
```
...
ggplot(top_d_duo_all_time, aes(x = n, y = fct_rev(duo), fill = abbreviation)) +
  ...
  scale_y_discrete(expand = c(0,0)) +
  labs(x = "Combined goals", y = NULL)
ggsave("Plots/best_d_duos.jpg", width = 8, height = 10, dpi = 300)
...
ggplot(top_duo_per_team, aes(x = n, y = fct_rev(duo_label), fill = abbreviation, alpha = factor(rank))) +
  ...
  scale_y_discrete(expand = c(0,0)) +
  labs(x = "Combined goals", y = NULL)
ggsave("Plots/team_high_duos.jpg", width = 14.5, height = 8, dpi = 300)
```
...
ggplot(top_duo_against_team, aes(x = n, y = fct_rev(duo_label), fill = abbreviation))+
  ...
  labs(x = "Combined goals", y = NULL)
ggsave("Plots/team_against_duos.jpg", width = 14.5, height = 12, dpi = 300)
```
...
ggsave("Plots/season_leaders.jpg", width = 15.5, height = 9.5, dpi = 300)
...
ggsave("Plots/duo_perc.jpg", width = 16.5, height = 7, dpi = 300)
